<!-- filepath: resources/views/admin/warehouse/received/index.blade.php -->
<x-app-layout>
    <x-slot name="header">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($logs as $log)
                                        <tr class="hover:bg-gray-50 transition">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-bold text-green-600">+{{ number_format($log->quantity) }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">{{ $log->receivedByUser->name ?? 'System' }}</div>
                                            </td>
                                            <td class="px-6 py-4">
