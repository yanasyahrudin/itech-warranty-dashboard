        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-blue-50 overflow-hidden shadow-sm sm:rounded-xl">
                        <div class="p-6">
                    ...
                    <div class="bg-red-50  overflow-hidden shadow-sm sm:rounded-xl">
                        <div class="p-6">
                ...
                <div class="lg:col-span-1">
                    @if($registration->status === 'pending')
                    <!-- Approve Form -->
                    <div class="bg-green-50  overflow-hidden shadow-sm sm:rounded-xl mb-6">
                        <div class="p-6">
                    ...
                    @else
                    <!-- Already Processed -->
                    <div class="bg-gray-50 overflow-hidden shadow-sm sm:rounded-xl">
                        <div class="p-6">
                            ...
                            @else
                            <div class="p-3 bg-red-100  rounded-xl mb-4">
