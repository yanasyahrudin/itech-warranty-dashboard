    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                                <strong>Catatan:</strong> Nomor seri akan secara otomatis dibuat berdasarkan jumlah yang Anda masukkan.
                            Anda akan dapat mencetaknya setelah pengiriman.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-6">Form Terima Produk </h3>
                    ...
                    <form action="{{ route('admin.warehouse.received.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Jumlah unit yang diterima (1-1000)</p>

                            <!-- Serial Number Preview -->
                            <div id="serialPreview" class="mt-2 p-3 bg-green-50 border border-green-200 rounded hidden">
                                <p class="text-sm text-green-800">
                                    <strong>Akan dibuat:</strong> <span id="serialCount">0</span> nomor seri unik
                                </p>
                            </div>
                        </div>
